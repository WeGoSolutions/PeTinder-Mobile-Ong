...
public class CriarPetCommand {
    ...
    public CriarPetCommand(String nome, Double idade, String porte, List<String> tags,
                           String descricao, Boolean isCastrado, Boolean isVermifugo,
                           Boolean isVacinado, String sexo, UUID ongId) {
        this.nome = nome;
        this.idade = idade;
        this.porte = porte;
        this.tags = tags;
